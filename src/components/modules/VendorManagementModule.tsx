  ...
  return (
    <div className="h-full p-4 overflow-auto">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h1 className="text-2xl font-semibold text-blue/90">Vendor Management</h1>
      </div>
      ...
      <div className="bg-gradient-to-t from-blue/5 to-light-blue/25 rounded-lg shadow-sm border">
        <div className="p-4">
          <div className="text-center py-12">
            ...
            <h2 className="text-xl font-medium text-blue/90 mb-2">Vendor Management Module</h2>
            <p className="text-blue/70 mb-6">This module is currently under development. Features will include vendor registration, contract management, and performance tracking.</p>
