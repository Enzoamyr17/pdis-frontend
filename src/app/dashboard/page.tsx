...
export default function Dashboard() {
  ...
  // Sort tasks: unchecked first (newest to oldest), then checked (newest to oldest)
  const sortedTasks = [...tasks].sort((a, b) => {
    if (a.completed === b.completed) {
      // If both have same completion status, sort by id descending (newest first)
      return b.id - a.id
    }
      ...
      <ResizablePanelGroup direction="horizontal">
        ...
        <ResizablePanel defaultSize={23}>
          ...
          <div className="flex flex-col gap-2 h-full overflow-y-auto max-w-full p-2 scrollbar-left">
            ...
            <div className="border border-zinc-500/10 shadow-sm bg-gradient-to-t from-blue/10 to-light-blue/45 rounded-xl p-2 overflow-hidden h-96">
              <h2 className="text-lg font-semibold mb-2 text-blue">Calendar</h2>
              <Calendar />  
            </div>
            <div className="border border-zinc-500/10 shadow-sm bg-gradient-to-t from-blue/10 to-light-blue/45 rounded-xl p-2 overflow-hidden">
        ...
        <ResizablePanel>
          <ResizablePanelGroup direction="vertical">
            <ResizablePanel minSize={6.5} className="p-2"> 
            ...
            <ResizableHandle withHandle />
            <ResizablePanel minSize={6.5} className="p-2">
              <div className="rounded-xl p-2 h-full border border-zinc-500/10 shadow-sm bg-gradient-to-t from-blue/10 to-light-blue/45 overflow-hidden flex flex-col">
                ...
                <div className="flex gap-2 mb-4">
                  ...
                  <button
                    onClick={addTask}
                    className="m-auto px-4 py-1 bg-blue text-white rounded-lg text-sm hover:bg-blue/90 transition-colors font-medium"
                  >
                    Add
                  </button>
                </div>
